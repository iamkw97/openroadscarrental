        ...
        <section id="section-car-details">
            <div class="container">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3">
                        <h3>BMW M2 2020</h3>
                        <p>The BMW M2 is the high-performance version of the 2 Series 2-door coupé. The first generation of
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="de-box mb25">
                            <form name="contactForm" id='contact_form' method="post">
                                ...
                                <a href="{{ route('personal.index') }}" class="btn-main btn-fullwidth">Book Now</a>
