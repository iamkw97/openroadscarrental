                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="blog-read">
                            ...
                            <img alt="" src="{{ asset('welcome/images/news/big.jpg')}}" class="img-fullwidth mb30">
                        ...
                        <div id="blog-comment">
                            ...
                            <ol>
                                <li>
                                    <div class="avatar">
                                        <img src="{{ asset('welcome/images/misc/avatar-2.jpg')}}" alt="">
                                    </div>
                    ...
                    <div id="sidebar" class="col-md-4">
                        ...
                        <div class="widget widget-post">
                            ...
                            <ul class="de-bloglist-type-1">
                                <li>
                                    <div class="d-image">
                                        <img src="{{ asset('welcome/images/news-thumbnail/pic-blog-1.jpg')}}" alt="">
                                    </div>
                                    <div class="d-content">
                                        <a href="#">
                                ...
                                <li>
                                    <div class="d-image">
                                        <img src="{{ asset('welcome/images/news-thumbnail/pic-blog-2.jpg')}}" alt="">
                                    </div>
                                    <div class="d-content">
                                        <a href="#">
                                ...
                                <li>
                                    <div class="d-image">
                                        <img src="{{ asset('welcome/images/news-thumbnail/pic-blog-3.jpg')}}" alt="">
                                    </div>
                                    <div class="d-content">
                                        <a href="#">
                                ...
                                <li>
                                    <div class="d-image">
                                        <img src="{{ asset('welcome/images/news-thumbnail/pic-blog-4.jpg')}}" alt="">
                                    </div>
                                    <div class="d-content">
                                        <a href="#">
