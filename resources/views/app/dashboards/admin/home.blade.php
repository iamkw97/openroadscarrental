                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    ...
                                    <h4 class="my-1">{{ \App\Models\Visitor::totalCount() }}</h4>
                                </div>
                ...
                <div class="col">
                    <div class="card radius-10">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    <p class="mb-0 text-secondary">Today's Total Visitors</p>
                                    <h4 class="my-1">{{ \App\Models\Visitor::todayTotalCount() }}</h4>
                                </div>
                                <div class="widgets-icons bg-light-info text-info ms-auto"><i class='bx bx-group'></i>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card radius-10">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    <p class="mb-0 text-secondary">Today's Mobile Visitors</p>
                                    <h4 class="my-1">{{ \App\Models\Visitor::todayMobileCount() }}</h4>
                                </div>
                                <div class="widgets-icons bg-light-info text-info ms-auto"><i class='bx bxs-mobile'></i>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card radius-10">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    <p class="mb-0 text-secondary">Today's Other Visitors</p>
                                    <h4 class="my-1">{{ \App\Models\Visitor::todayDesktopCount() }}</h4>
                                </div>
                                <div class="widgets-icons bg-light-info text-info ms-auto"><i class='bx bx-desktop'></i>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="list-group list-group-flush">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="license_validity" class="form-label">License
                                                            Validity</label>
                                                        <input id="license_validity" name="license_validity"
                                        ...
                                        <div class="list-group-item mb-3">
                                            ...
                                            <div class="row my-2">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-check">
                                                        <input id="additional_wifi" name="additional_wifi"
                                                            type="checkbox" class="form-check-input" disabled>
                                                        <label for="additional_wifi"
                                                            class="form-check-label"><strong>Additional
                                                                Wi-Fi</strong></label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <div class="list-group-item mb-3">
                                            ...
                                            <div class="row my-1">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="displaying_name" class="form-label">Vehicle
                                                            Name</label>
